          ...
          <div className="max-w-md mx-auto bg-zinc-900 border border-zinc-800 rounded-xl p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div
                ...
                className="bg-zinc-800/50 hover:bg-zinc-800 border border-zinc-700/50 rounded-xl p-4 cursor-pointer transition-all flex items-center justify-center gap-3"
              >
                ...
                <span className="font-medium text-white">Criar conta com Google</span>
              </div>
            </form>
          </div>
        )}
