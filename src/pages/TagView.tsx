...
export const TAG_CONFIG: Record<string, { name: string, emoji: string, bgImage: string | null, description: string, key: keyof Content }> = {
    'portugal': { name: 'Portugal', emoji: '🇵🇹', bgImage: '/bandeira/pt.png?v=2', description: 'Filmes e séries de Portugal ou com áudio PT-PT.', key: 'tag_portugal' },
    'brasil': { name: 'Brasil', emoji: '🇧🇷', bgImage: '/bandeira/br.png?v=2', description: 'Filmes e séries do Brasil ou com áudio PT-BR.', key: 'tag_brasil' },
